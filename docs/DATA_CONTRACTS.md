...
**Split rather than combined, settled 16/08/2026.** Hashing `id + ':' + password`
...
- **ID length is not validated.** Staff who joined before the school moved to five-digit
  numbers really do have three and four digits. Confirmed 16/08/2026.
...
**Generated, not hand-written** (changed 16/08/2026). `scripts/make-datasets.mjs`
